            ...
            switch(opcion){     
                ...
                case 4: //Reportes
                    if(presupuesto > 0){
                        ...
                        double mayorCant = 0;
                        if(cantAzucar > mayorCant) mayorCant = cantAzucar;
                        if(cantAvena > mayorCant) mayorCant = cantAvena;
                        if(cantTrigo > mayorCant) mayorCant = cantTrigo;
                        if(cantMaiz > mayorCant) mayorCant = cantMaiz;

                        String productosEstrella = "";
                        if(cantAzucar == mayorCant && mayorCant > 0) productosEstrella += "Azucar, ";
                        if(cantAvena == mayorCant && mayorCant > 0) productosEstrella += "Avena, ";
                        if(cantTrigo == mayorCant && mayorCant > 0) productosEstrella += "Trigo, ";
                        if(cantMaiz == mayorCant && mayorCant > 0) productosEstrella += "Maiz, ";
